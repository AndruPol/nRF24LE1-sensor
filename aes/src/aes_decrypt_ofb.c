...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// void aes_decrypt_ofb(aes_data_t * aes_data_p, const unsigned char * input_cipher_text_block,
//                      unsigned char * output_plain_text_block, unsigned int len);
//
// Description:
//  Decrypts an input block of cipher text into an output block of plain text using output feedback (OFB) mode
//
// Parameters:
...
void aes_decrypt_ofb(aes_data_t * aes_data_p, const unsigned char * input_cipher_text_block, unsigned char * output_plain_text_block, unsigned int len) __REENTRANT
{
	...
	//Since OFB allows turning a block cipher into a stream cipher, we can decrypt as many bytes as we want
	for(i = 0; i < len; i++)
	{
		...
		// 2. Decrement the number of remaining key block bytes
